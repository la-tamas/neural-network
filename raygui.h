...
int GuiGroupBox(Rectangle bounds, const char *text)
{
    ...
    // Draw control
    //--------------------------------------------------------------------
    GuiDrawRectangle(RAYGUI_CLITERAL(Rectangle){ bounds.x, bounds.y, RAYGUI_GROUPBOX_LINE_THICK, bounds.height }, 0, BLANK, GetColor(GuiGetStyle(DEFAULT, (state == STATE_DISABLED)? static_cast<int>(BORDER_COLOR_DISABLED) : static_cast<int>(LINE_COLOR))));
    GuiDrawRectangle(RAYGUI_CLITERAL(Rectangle){ bounds.x, bounds.y + bounds.height - 1, bounds.width, RAYGUI_GROUPBOX_LINE_THICK }, 0, BLANK, GetColor(GuiGetStyle(DEFAULT, (state == STATE_DISABLED)? static_cast<int>(BORDER_COLOR_DISABLED) : static_cast<int>(LINE_COLOR))));
    GuiDrawRectangle(RAYGUI_CLITERAL(Rectangle){ bounds.x + bounds.width - 1, bounds.y, RAYGUI_GROUPBOX_LINE_THICK, bounds.height }, 0, BLANK, GetColor(GuiGetStyle(DEFAULT, (state == STATE_DISABLED)? static_cast<int>(BORDER_COLOR_DISABLED) : static_cast<int>(LINE_COLOR))));
...
int GuiLine(Rectangle bounds, const char *text)
{
    ...
    Color color = GetColor(GuiGetStyle(DEFAULT, (state == STATE_DISABLED)? static_cast<int>(BORDER_COLOR_DISABLED) : static_cast<int>(LINE_COLOR)));
...
int GuiPanel(Rectangle bounds, const char *text)
{
    ...
    GuiDrawRectangle(bounds, RAYGUI_PANEL_BORDER_WIDTH, GetColor(GuiGetStyle(DEFAULT, (state == STATE_DISABLED)? static_cast<int>(BORDER_COLOR_DISABLED): static_cast<int>(LINE_COLOR))),
                     GetColor(GuiGetStyle(DEFAULT, (state == STATE_DISABLED)? static_cast<int>(BASE_COLOR_DISABLED) : static_cast<int>(BACKGROUND_COLOR))));
    //--------------------------------------------------------------------
